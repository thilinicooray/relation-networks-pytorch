        ...
        for i, (img, verb, roles,labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{0}_verb_1fc_resnet_man_loss1_decay.model".format(max_score))
...
def main():
    ...
    print('LR scheme : lr decay, 1fc resnet, manual loss 1', 1e-5, 0.1,25)
