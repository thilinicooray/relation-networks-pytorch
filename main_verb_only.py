        ...
        for i, (img, verb, roles,labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{0}_verb_only256_cosanwr0.1.model".format(max_score))
...
def main():
    ...
    print('LR scheme : cosine annealing wr alpha_0, T, M', 0.1, 1200000, 50)
    ...
    optimizer = utils.CosineAnnealingWR(0.1,1200000 , 50,
