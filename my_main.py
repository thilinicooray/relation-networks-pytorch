...
def train(model, train_loader, dev_loader, traindev_loader, optimizer, scheduler, max_epoch, model_dir, encoder, gpu_mode, clip_norm, lr_max, eval_frequency=500):
    model.train()
    train_loss = 0
    total_steps = 0
    print_freq = 50
...
def main():
    ...
    traindev_loader = torch.utils.data.DataLoader(traindev_set, batch_size=64, shuffle=True, num_workers=n_worker)
