        ...
        for i, (img, verb, roles,labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_{}_512_att4_decaye4_b64_h8_do5.model".format(max_score, model_name))
...
def main():
    ...
    print('model spec :, 512 hidden, 25 epoch decay e-4, att, 4 layers transformer b64,8 head 0.5do ')
