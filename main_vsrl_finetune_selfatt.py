        ...
        for i, (img, verb, roles,labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_{}_4e_4_b32_train_gt_epo25dec_selfatt.model".format(max_score, model_name))
...
def main():
    ...
    print('model spec :, 512 hidden, 5e-4 init lr, 25 epoch decay, 3 layer mlp for g, 3 att layers')
