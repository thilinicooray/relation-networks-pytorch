        ...
        for i, (img, verb, roles,labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{0}_verb_only256_trans_15kwarmup.model".format(max_score))
...
def main():
    ...
    print('LR scheme :transformer warmup, factor, size ', 15000, 0.1, 256)
    ...
    optimizer = utils.NoamOpt(256, 0.1, 15000,
